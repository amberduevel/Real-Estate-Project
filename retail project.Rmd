...
```{r}
model1 = lm(Total_Value_Real_estate_Transferred~Property_Type1+Total_acres+Feet_water_frontage+Number_of_units+`Energy Exclusion`+Arms_length+Primary_Class+Water_type+Property_Type1, data = onalaskaRE)
summary(model1)
```
