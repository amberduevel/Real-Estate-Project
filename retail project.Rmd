...
```{r}
model4 = lm(log(Total_Value_Real_estate_Transferred)~Property_Type1+Total_acres+Number_of_units+`Energy Exclusion`, data = onalaskaRE)
summary(model4)
anova(model4)
...
model_test = lm(log(Total_Value_Real_estate_Transferred)~(Property_Type1+Total_acres+Number_of_units+`Energy Exclusion`)^2, data = onalaskaRE)
step(model_test, direction = "backward")
